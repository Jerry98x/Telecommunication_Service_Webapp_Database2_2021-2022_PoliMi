...
@WebServlet("/GetTotalPurchasePerSp")
@MultipartConfig
public class GetTotalPurchasesPerSp extends HttpServlet {
    ...
    public GetTotalPurchasesPerSp() { super(); }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = gson.toJson(mvTotalPurchasesPerSps);
