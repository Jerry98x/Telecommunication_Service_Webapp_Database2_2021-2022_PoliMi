...
import it.polimi.db2_project_20212022_fontana_gerosa.beans.mv.MVTotalValuePerSp;
...
@WebServlet("/GetTotalValuePerSp")
@MultipartConfig
public class GetTotalValuePerSp extends HttpServlet {
    ...
    public GetTotalValuePerSp() { super(); }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = gson.toJson(mvTotalValuePerSps);
