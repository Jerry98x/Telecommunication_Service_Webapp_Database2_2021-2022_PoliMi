...
import it.polimi.db2_project_20212022_fontana_gerosa.beans.mv.MVTotalPurchasesPerSpAndVp;
...
@WebServlet("/GetTotalPurchasesPerSpAndVp")
@MultipartConfig
public class GetTotalPurchasesPerSpAndVp extends HttpServlet {
    ...
    public GetTotalPurchasesPerSpAndVp() { super(); }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = gson.toJson(mvTotalPurchasesPerSpAndVps);
