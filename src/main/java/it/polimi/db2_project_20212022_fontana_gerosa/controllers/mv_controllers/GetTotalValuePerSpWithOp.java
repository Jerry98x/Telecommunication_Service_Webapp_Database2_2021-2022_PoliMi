...
import it.polimi.db2_project_20212022_fontana_gerosa.beans.mv.MVTotalValuePerSpWithOp;
...
@WebServlet("/GetTotalValuePerSpWithOp")
@MultipartConfig
public class GetTotalValuePerSpWithOp extends HttpServlet {
    ...
    public GetTotalValuePerSpWithOp() { super(); }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = gson.toJson(mvTotalValuePerSpWithOps);
