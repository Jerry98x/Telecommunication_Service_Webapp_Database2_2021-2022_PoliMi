...
import it.polimi.db2_project_20212022_fontana_gerosa.beans.mv.MVTotalPurchasesPerOp;
...
@WebServlet("/GetTotalPurchasesPerOp")
@MultipartConfig
public class GetTotalPurchasesPerOp extends HttpServlet {
    ...
    public GetTotalPurchasesPerOp() { super(); }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = gson.toJson(mvTotalPurchasesPerOps);
